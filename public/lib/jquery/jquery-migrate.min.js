...
jQuery.migrateMute === void 0 && (jQuery.migrateMute = !0), function (e, t, n) {
	...
	a(e, "attrFn", i, "jQuery.attrFn is deprecated"), e.attr = function (t, a, o, i) {
		...
		return i && 4 > s.length && (r("jQuery.fn.attr( props, pass ) is deprecated"), t && !d.test(c) && e.isFunction(e.fn[a])) ? e(t)[a](o) : ("type" === a && o !== n && l.test(t.nodeName) && t.parentNode && r("Can't change the 'type' of an input or button in IE 6/7/8"), !e.attrHooks[u] && p.test(u) && (e.attrHooks[u] = {get: function (t, r) {
			var a, o = e.prop(t, r);
